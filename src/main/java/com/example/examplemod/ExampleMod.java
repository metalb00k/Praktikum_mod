...
import static com.example.examplemod.block.ModBlocks.TESTBLOCK;
import static com.example.examplemod.block.ModBlocks.TESTORE;
...
public class ExampleMod
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        event.accept(TESTORE);

        if (event.getTabKey() == CreativeModeTabs.COMBAT)
            event.accept(ITEMTEST);
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES)
            event.accept(METALDETECTOR);
